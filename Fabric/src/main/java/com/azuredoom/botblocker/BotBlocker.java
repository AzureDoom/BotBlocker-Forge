        ...
        ServerPlayConnectionEvents.DISCONNECT.register((handler, server) -> {
            ...
            if (Constants.joinTimes.containsKey(playerId)) {
                ...
                if (timeConnected < Constants.timeLimit) {
                    ...
                    handler.player.connection.disconnect(new TranslatableComponent(Constants.MESSAGE_DISCONNECT));
            ...
            dispatcher.register(Commands.literal(Constants.MOD_ID)
                    .then(Commands.literal(Constants.COMMAND_ENABLE)
                            .executes(context -> {
                                ...
                                context.getSource().sendSuccess(new TranslatableComponent(Constants.MESSAGE_ENABLED),
                                        true);
            ...
            dispatcher.register(Commands.literal(Constants.MOD_ID)
                    .then(Commands.literal(Constants.COMMAND_DISABLE)
                            .executes(context -> {
                                ...
                                context.getSource().sendSuccess(new TranslatableComponent(Constants.MESSAGE_DISABLED),
                                        true);
